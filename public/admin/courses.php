...
async function loadPendingCourses() {
    try {
        ...
        const pending = courses.filter(c => c.status === 'pending' || c.status === 'pending_reapproval').length;
        ...
        tbody.innerHTML = courses.map(c => {
            ...
            const actions = (c.status === 'pending' || c.status === 'pending_reapproval')
