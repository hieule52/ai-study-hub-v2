<?php
$pageTitle = 'Hồ Sơ Giảng Viên - AI Study Hub';
$actor = 'teacher';
$noSidebar = true;
...
<div class="teacher-layout">
    ...
    <main class="teacher-content">
        <div class="profile-container">
            ...
            <div class="profile-header" style="margin-bottom: 2.5rem;">
                ...
                <h1 class="profile-title" data-i18n="profile_title" style="background: linear-gradient(to bottom, #fff, #94a3b8); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Cài đặt Tài khoản</h1>
                <p class="text-secondary" data-i18n="profile_subtitle">Quản lý hồ sơ giảng viên và bảo mật cá nhân.</p>
            </div>

            <!-- Identity Section -->
            <div class="card glass-panel avatar-section" style="border: 1px solid var(--glass-border); border-radius: var(--radius-lg); background: rgba(15, 23, 42, 0.3) !important;">
                ...
                <div>
                    <h3 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 0.2rem; color: #fff;" id="ui-username">...</h3>
                    <div style="color: var(--text-secondary); font-size: 0.95rem; opacity: 0.7;" id="ui-email">...</div>
                    <div style="margin-top: 1rem;">
                        <span id="ui-role" style="font-size: 0.7rem; padding: 0.3rem 0.8rem; background: rgba(99,102,241,0.15); color: var(--primary); border: 1px solid rgba(99,102,241,0.3); border-radius: 100px; font-weight: 800; letter-spacing: 0.05em;">TEACHER</span>
                    </div>
                </div>
            </div>

            <!-- Update Info Form -->
            <div class="card glass-panel profile-form-card" style="border: 1px solid var(--glass-border); border-radius: var(--radius-lg); background: rgba(15, 23, 42, 0.2) !important;">
                <h3 style="margin-bottom: 2rem; display: flex; align-items: center; gap: 12px; font-weight: 800; color: #fff;">
            ...
            <div class="card glass-panel profile-form-card" style="border: 1px solid rgba(239, 68, 68, 0.15); border-radius: var(--radius-lg); background: rgba(15, 23, 42, 0.2) !important;">
                <h3 style="margin-bottom: 2rem; display: flex; align-items: center; gap: 12px; font-weight: 800; color: #fff;">
                ...
                <form id="passwordForm" onsubmit="changePassword(event)">
                    ...
                    <div class="flex justify-end" style="display: flex; justify-content: flex-end;">
                        <button type="submit" class="btn btn-outline" style="border-radius: 100px; padding: 0.75rem 2rem; border-color: rgba(239, 68, 68, 0.3); color: var(--danger); background: none; font-weight: 600; cursor: pointer;" id="btnSavePass">
